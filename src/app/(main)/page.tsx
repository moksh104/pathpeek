      ...
      <div className="relative z-10">
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-5 tracking-tight text-gray-900 dark:text-white">
              Discover your next
              <span className="block mt-1 bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent">
                adventure
              </span>
            </h1>
            <p className="text-base sm:text-lg max-w-md mx-auto text-gray-600 dark:text-gray-400">
              Curated travel escapes matching your mood and budget across India
            </p>
          </div>
          ...
          <div className="mb-14 sm:mb-16">
            <div className="mb-8">
              <label className="block text-xs font-semibold uppercase tracking-wider mb-4 text-gray-500 dark:text-gray-400">
                Select mood
              </label>
                ...
                {moodOptions.map((mood) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 sm:px-5 py-2.5 sm:py-3 rounded-full font-medium transition-all duration-300 ${
                        isSelected
                          ? `bg-gradient-to-r ${mood.color} text-white shadow-lg shadow-violet-500/20`
                          : 'bg-white dark:bg-white/[0.03] text-gray-700 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/[0.06] hover:text-gray-900 dark:hover:text-gray-200 border border-gray-200 dark:border-white/[0.04] shadow-sm'
                      }`}
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div>
                ...
                <div className="rounded-2xl p-6 bg-white dark:bg-white/[0.02] border border-gray-200/80 dark:border-white/[0.04] shadow-sm">
                  <div className="flex items-baseline justify-between mb-6">
                    <span className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">
                      ₹{budget.toLocaleString('en-IN')}
                    </span>
                    <Badge className="bg-emerald-50 dark:bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border-0 px-3 py-1 text-xs font-medium">
                  ...
                  <Slider
                    ...
                    className="w-full"
                  />
                  <div className="flex justify-between text-xs mt-4 text-gray-400 dark:text-gray-500">
                    <span>₹1,000</span>
                    <span>₹1,00,000</span>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-11 pr-10 h-12 rounded-xl text-sm bg-white dark:bg-white/[0.02] border-gray-200 dark:border-white/[0.04] shadow-sm"
                  />
                  {citySearch && (
                    <button
                ...
                <button
                  ...
                  } bg-violet-50 hover:bg-violet-100 dark:bg-violet-500/10 dark:hover:bg-violet-500/15 text-violet-700 dark:text-violet-400 border border-violet-200 dark:border-violet-500/20`}
                >
                  {isLocating ? (
                    <>
                    ...
                    <button
                      ...
                      className={`text-xs px-3 py-1.5 rounded-full transition-all ${
                        citySearch.toLowerCase() === city.toLowerCase()
                          ...
                          : 'bg-gray-100 hover:bg-gray-200 dark:bg-white/[0.02] dark:hover:bg-white/[0.05] text-gray-600 dark:text-gray-400'
                      }`}
                    >
                      {city}
                    </button>
              ...
              <div className="flex items-center gap-3">
                ...
                {(selectedMood || citySearch) && (
                  <button
                    ...
                    className="flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-lg text-gray-500 hover:bg-gray-100 dark:hover:bg-white/[0.05]"
                  >
                    <X className="w-3 h-3" />
                    Clear
                  </button>
