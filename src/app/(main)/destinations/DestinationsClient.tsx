  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
      ...
      <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-12">
        <Badge className="mb-3 bg-violet-100 dark:bg-violet-950/60 text-violet-700 dark:text-violet-300 border-violet-200 dark:border-violet-800 text-xs px-3 py-1 font-medium">
      ...
      <div className="rounded-2xl bg-white dark:bg-white/[0.02] border border-gray-200/80 dark:border-white/[0.06] p-5 sm:p-6 shadow-sm mb-10 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
          <div className="lg:col-span-6 relative">
            ...
            <Input
              ...
              className="pl-10 pr-9 h-11 rounded-xl bg-gray-50/70 dark:bg-white/[0.03] border-gray-200 dark:border-white/[0.08]"
            />
            {searchQuery && (
              <button
        ...
        <div className="pt-2 border-t border-gray-100 dark:border-white/[0.04]">
          ...
          <Slider
            ...
            className="w-full"
          />
          <div className="flex justify-between text-[11px] text-gray-400 dark:text-gray-500 mt-2">
            <span>₹2,000</span>
            <span>₹30,000</span>
            <span>₹60,000+</span>
          </div>
